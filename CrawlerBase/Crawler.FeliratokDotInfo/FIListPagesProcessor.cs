...
namespace Crawler.FI
{
    ...
    {
        public FIListPagesProcessor(ISelector<List<string>> Selector, IOperationBaseElement OpPipe, ILogger logger, PageDownloaderMode pageDownloaderMode = PageDownloaderMode.String)
